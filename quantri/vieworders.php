                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="status" id="">
                                                    <option <?= $row['status'] == 'Processing' ? 'selected' : '' ?>>Đang xử lý
                                                    </option>
                                                    <option <?= $row['status'] == 'Confirmed' ? 'selected' : '' ?>>Đã xác nhận
                                                    </option>
                                                    <option <?= $row['status'] == 'Shipping' ? 'selected' : '' ?>>Đang vận chuyển
                                                    </option>
                                                    <option <?= $row['status'] == 'Delivered' ? 'selected' : '' ?>>Đã được giao
                                                    </option>
                                                    <option <?= $row['status'] == 'Cancelled' ? 'selected' : '' ?>>Đã hủy
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
