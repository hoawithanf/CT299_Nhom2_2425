            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="#">Trang</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./sanpham.php">Chi Tiết Sản Phẩm</a></li>
                                    <li><a href="./shoping-cart.html">Giỏ Hàng</a></li>
                                    <li><a href="./checkout.html">Thanh Toán</a></li>
                                    <li><a href="./blog-details.html">Tin Tức</a></li>
                                </ul>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        <div class="header__cart__price">Tổng: <span>0 VND</span></div>
                    </div>
                </div>
            </div>
...
<section class="checkout spad">
    <div class="container">
        <div class="checkout__form">
            ...
            Nếu bạn có nhu cầu cần hỗ trợ hãy liên hệ qua số hotline của chúng tôi ở trên!
            <br>
            <h6>Quay về <a href="index.php">trang chủ</a></h6>
            </h4>
